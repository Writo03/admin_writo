...
const Home = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
      <h1 className="text-4xl font-bold text-gray-800 mb-6">Welcome to the Quiz Management System</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 w-full max-w-4xl px-4">
        <Link to={'/student-list'}>
          <div className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
            ...
            <p className="text-gray-600 mt-2">View and manage the student list.</p>
          </div>
        </Link>
        ...
        <Link to={'/mentor-list'}>
          <div className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
            ...
            <p className="text-gray-600 mt-2">Explore and manage mentor profiles.</p>
          </div>
        </Link>
        ...
        <Link to={'/all-quizes'}>
          <div className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
            <h2 className="text-xl font-semibold text-orange-500">Show Quizzes</h2>
